...
//var variable general

let cadenaUno = "Esta es una cadena";
let cadenaDos = 'Segunda cadena';
let cadenaTres = String("Tercera cadena");// función de String
let cadenaCuatro = new String('Cuarta cadena'); // Objeto String
...
console.log(parseFloat("3.14 valor de pi")); //pi
console.log(parseInt("110",2));//bin
console.log(parseInt("A",16)); //hex
